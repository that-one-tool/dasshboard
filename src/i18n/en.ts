...
export const en = {
	...
	"header.files.title": "Show or hide the Files (SFTP) panel",
	...
	"grid.broadcast.aria": "Broadcast typing to all connected panes",
	...
	"pane.status.connected": "Connected",
	"pane.status.disconnected": "Disconnected",
	...
	"settings.keepalive.countMax.hint": "Drop the connection after this many unanswered pings.",
	"settings.sftp.idleDisconnect": "SFTP idle disconnect (min)",
	...
	"devices.empty": "No hosts/devices yet.<br />Click <strong>+ Add</strong> above to create your first one.",
	"devices.noMatches": "No devices match your search.",
	"devices.search.placeholder": "Search devices…",
	"devices.search.aria": "Search devices by name, host or tag",
	"devices.group.untagged": "Untagged",
	"devices.field.tags": "Tags",
	"devices.field.tags.placeholder": "web, prod (comma-separated)",
	...
	"devices.kind.localShell": "Local shell",
	"devices.field.shell": "Shell",
	"devices.field.shell.placeholder": "Leave blank for the default shell",
	"devices.field.cwd": "Startup directory",
	"devices.field.cwd.placeholder": "Leave blank for your home directory",
	"devices.field.connectSnippet": "Commands on connect",
	"devices.field.connectSnippet.placeholder": "cd /var/log\ntail -f app.log",
	"devices.field.connectSnippet.hint": "Typed into the terminal after connecting, one line at a time, as if you pressed Enter.",
	...
	"devices.field.agentIdentity": "Agent identity",
	"devices.agent.refresh": "Refresh",
	"devices.agent.loading": "Querying the SSH agent…",
	"devices.agent.empty": "The agent is running but holds no keys.",
	"devices.agent.error": "No SSH agent reachable.",
	"devices.agent.notPresent": "(not currently in the agent)",
	...
	"devices.field.proxyJump": "Jump host (ProxyJump)",
	"devices.proxyJump.none": "None (direct connection)",
	...
	"validation.agentIdentity": "Select an agent identity for agent-based authentication",
	...
	"sftp.selectDevice": "Select a device…",
	"sftp.disconnect": "Disconnect",
	"sftp.collapse": "Collapse panel",
	"sftp.expand": "Expand panel",
	"sftp.connect": "Connect",
	"sftp.notConnected": "Not connected.",
	"sftp.pickDevice": "Pick a device above to browse its files.",
	"sftp.idleDisconnected": "Disconnected after being idle.",
	"sftp.path.aria": "Current directory",
	"sftp.path.edit": "Type a path and press Enter to go there",
	"sftp.nav.copyPath": "Copy current path",
	"sftp.pathCopied": "Path copied to clipboard",
	...
	"sftp.entry.permissions": "Permissions",
	"sftp.entry.delete": "Delete",
	"sftp.filter.aria": "Filter this folder",
	"sftp.filter.placeholder": "Filter…",
	"sftp.sort.aria": "Sort by",
	"sftp.sort.name": "Name",
	"sftp.sort.size": "Size",
	"sftp.sort.modified": "Modified",
	"sftp.bookmark.add": "Bookmark this folder",
	"sftp.bookmark.remove": "Remove bookmark",
	"sftp.perms.title": "Permissions",
	"sftp.perms.changed": "Permissions changed for {name}",
	"sftp.perms.read": "Read",
	"sftp.perms.write": "Write",
	"sftp.perms.exec": "Execute",
	"sftp.perms.owner": "Owner",
	"sftp.perms.group": "Group",
	"sftp.perms.other": "Other",
	"sftp.delete.title": "Delete?",
	"sftp.delete.message": 'Delete "{name}"? This cannot be undone.',
	"sftp.delete.messageDir": 'Delete "{name}" and everything inside it? This cannot be undone.',
	...
	"sftp.queue.title": "Transfers",
	"sftp.queue.clear": "Clear",
	"sftp.queue.queued": "Queued",
	"sftp.queue.failed": "Failed",
	"sftp.selectAll": "Select all",
	"sftp.selected.one": "1 selected",
	"sftp.selected.other": "{count} selected",
	"sftp.bulk.download": "Download",
	"sftp.bulk.move": "Move",
	"sftp.bulk.paste": "Paste",
	"sftp.bulk.clear": "Clear",
	"sftp.bulk.partial": "Some items could not be completed.",
	"sftp.cutNotice.one": "1 item cut — open a folder and Paste",
	"sftp.cutNotice.other": "{count} items cut — open a folder and Paste",
	"sftp.deleteConfirm.one": "Delete 1 selected item? This cannot be undone.",
	"sftp.deleteConfirm.other": "Delete {count} selected items? This cannot be undone.",
	"sftp.deleted.one": "1 item deleted",
	"sftp.deleted.other": "{count} items deleted",
	"sftp.moved.one": "1 item moved",
	"sftp.moved.other": "{count} items moved",
	"sftp.downloadedFiles.one": "1 file downloaded",
	"sftp.downloadedFiles.other": "{count} files downloaded",
	"sftp.move.intoSelf": "Can't move a folder into itself.",
	"sftp.move.exists": "Skipped items that already exist here.",
	"sftp.nav.uploadDir": "Upload a folder here",
	"sftp.downloadingFolder": "Downloading folder {name}…",
	"sftp.uploadingFolder": "Uploading folder {name}…",
	"sftp.downloadedFolderToast": "Downloaded {name}",
	"sftp.uploadedFolderToast": "Uploaded {name}",
	"sftp.conflict.title": "Already exists",
	"sftp.conflict.message": "\"{name}\" already exists at the destination. What do you want to do?",
	"sftp.conflict.messageMany": "Some selected items already exist at the destination. What do you want to do?",
	"sftp.conflict.overwrite": "Overwrite",
	"sftp.conflict.skip": "Skip existing",
	"sftp.conflict.rename": "Keep both",
